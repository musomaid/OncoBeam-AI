      ...
      <div className="relative overflow-hidden rounded-[1.9rem] border border-neon/25 bg-card/75 p-2 backdrop-blur-3xl shadow-[0_20px_70px_rgba(0,0,0,0.55),0_0_28px_rgba(0,209,255,0.22)]">
        ...
        <div className="grid grid-cols-5 gap-1">
          {items.map(({ key, icon: Icon, label }) => {
            ...
            return (
              <motion.button key={key} onClick={() => setTab(key)} whileTap={{ scale: 0.9 }} className="relative rounded-2xl px-1 pb-1.5 pt-2 text-center">
                ...
                <div className="relative z-10">
                  <motion.div animate={active ? { y: [-0.5, -2, -0.5] } : { y: 0 }} transition={{ duration: 1.4, repeat: active ? Infinity : 0 }}>
